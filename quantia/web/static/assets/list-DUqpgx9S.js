import{q as ue,j as fe,ap as me,V as pe,Z as _e,a5 as ye,b as ve,aq as ge,p as ke,n as be,ar as we,as as xe,W as he,at as Ce,au as Te,D as Ee,k as Se,a as r,ao as O}from"./vendor-element-51zLuKaP.js";import{d as De,m as Fe,c as x,J as F,a as z,H as Ae,A as k,r as m,P as l,G as o,M as b,b as N,o as u,L as d,u as A,O as Be,a5 as Ve,al as ze,ay as Ie,n as Ke}from"./vendor-vue-D92-bNgp.js";import{c as Me,r as j,e as q,s as Y,f as Ne,h as Re,i as Pe,m as Le,j as $e,k as Ge}from"./stock-C8x9RrXm.js";import{_ as Oe}from"./index-CEC8Nis4.js";import"./vendor-utils-Dgff_Vws.js";import"./vendor-BxkMN6og.js";const je={class:"algo-list"},qe={key:0,class:"breadcrumb"},Ye={class:"folder-path"},He={class:"toolbar"},Je={class:"name-cell"},Ue={key:3,class:"name-text"},We={key:0},Ze={key:0},Qe={style:{display:"flex",gap:"12px"}},Xe=De({__name:"list",setup(et){const H=Ie(),_=m([]),h=m([]),B=m(!1),p=m([]),v=m(0),I=m(""),C=m(null),V=m(""),T=m(!1),K=m(null),J={stock:"Code",multi_factor:"Factor",portfolio:"Portfolio",blank:"Code"},R={stock:`# 股票策略
