import{q as ue,j as fe,ao as me,U as pe,Y as _e,a3 as ye,b as ve,ap as ge,p as ke,n as be,aq as we,ar as xe,V as he,as as Ce,at as Te,C as Ee,k as Se,a as r,an as O}from"./vendor-element-D-Md3oXp.js";import{t as De,h as Fe,A as x,J as F,C as z,H as Ae,x as k,r as m,P as l,G as o,M as b,c as N,y as u,L as d,u as A,O as Be,a5 as Ve,al as ze,ay as Ie,n as Ke}from"./vendor-vue-CVBg90eC.js";import{c as Me,r as Y,e as j,s as q,f as Ne,h as Re,i as Pe,m as Le,j as $e,k as Ge}from"./stock-CNUTfz-_.js";import{_ as Oe}from"./index-CILlHCLp.js";import"./vendor-utils-Dgff_Vws.js";import"./vendor-BxkMN6og.js";const Ye={class:"algo-list"},je={key:0,class:"breadcrumb"},qe={class:"folder-path"},Ue={class:"toolbar"},He={class:"name-cell"},Je={key:3,class:"name-text"},Qe={key:0},We={key:0},Xe={style:{display:"flex",gap:"12px"}},Ze=De({__name:"list",setup(et){const U=Ie(),_=m([]),h=m([]),B=m(!1),p=m([]),v=m(0),I=m(""),C=m(null),V=m(""),T=m(!1),K=m(null),H={stock:"Code",multi_factor:"Factor",portfolio:"Portfolio",blank:"Code"},R={stock:`# 股票策略
