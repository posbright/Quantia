import{d as fe,o as me,c as h,f as B,e as N,D as pe,g as b,l as p,k as l,w as o,r as f,t as w,q as M,G as _e,j as u,n as d,h as K,L as ye,M as ve,F as ge,v as ke,N as be,O as we,P as xe,m as he,E as r,b as Ce,K as j,I as Se,_ as Te}from"./index-CLIfSl4R.js";import{c as Fe,r as Y,e as q,s as U,f as De,h as Ae,i as Be,m as Ke,j as ze,k as Ee}from"./stock-CXGze6RP.js";const Ne={class:"algo-list"},Ve={key:0,class:"breadcrumb"},Re={class:"folder-path"},Ie={class:"toolbar"},Me={class:"name-cell"},Pe={key:3,class:"name-text"},$e={key:0},Le={key:0},Ge={style:{display:"flex",gap:"12px"}},Oe=fe({__name:"list",setup(je){const H=Ce(),y=p([]),C=p([]),z=p(!1),_=p([]),g=p(0),V=p(""),S=p(null),E=p(""),T=p(!1),R=p(null),J={stock:"Code",multi_factor:"Factor",portfolio:"Portfolio",blank:"Code"},P={stock:`# 股票策略
