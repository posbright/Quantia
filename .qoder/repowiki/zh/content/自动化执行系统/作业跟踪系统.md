...
graph TB
subgraph "作业跟踪系统"
A[quantia/lib/job_tracker.py<br/>作业状态追踪器]
B[quantia/job/init_job.py<br/>数据库初始化作业]
C[quantia/job/execute_daily_job.py<br/>完整每日作业编排]
D[quantia/bin/run_job.sh<br/>作业执行脚本]
E[quantia/bin/run_cron.sh<br/>定时任务脚本]
