...
graph TB
subgraph "容器层"
A["Quantia 应用容器<br/>端口: 9988/9001"]
...
```mermaid
graph TB
LB["负载均衡/反向代理<br/>监听 80/443"] --> APP1["Quantia 实例1<br/>9988/9001"]
LB --> APP2["Quantia 实例2<br/>9988/9001"]
LB --> APPN["Quantia 实例N<br/>9988/9001"]
