...
| `run_fund_profile_holding` | 每月 | `fetch_fund_profile_job.py` + `fetch_fund_holding_job.py` + `fetch_fund_manager_job.py` | F10 基金画像（规模/经理/评级）+ F12 季度前十大重仓股 + P4 基金经理经验（`fund_manager_em` 全量）采集 |
