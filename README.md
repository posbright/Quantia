...
- 选股验证中心：策略对比、买卖点优化、策略融合（v2 五维加权/投票/条件树/轮动）、因子实验室。默认验证模板推荐 `m1_auto_ic_m12`，`m1_auto_ic_m15` / `m1_auto_ic_m16` 仅作为约束实验分支。
...
- 选股验证中心：策略对比、买卖点优化、策略融合（v2 五维）、因子实验室。默认因子验证模板用 `m1_auto_ic_m12`，`m1_auto_ic_m15` / `m1_auto_ic_m16` 只作约束实验对照。
